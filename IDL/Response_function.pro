;; ========== Creating response function from CHIANTI ===============
...
;; If there are multiple close lines, we can take a narrow wavelength limit to select a single by assigning wavelength band in wlim variable (in Angstrom) line like below
